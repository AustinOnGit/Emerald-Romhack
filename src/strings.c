...
const u8 gText_EggFromHotSprings[] = _("A POKéMON EGG given as\n a gift.");
...
const u8 gText_BrawlyMatchCallDesc[] = _("SPIRIT TAMER"); //change this later. not creative enough to come up with something atm
...
const u8 gText_JuanMatchCallDesc[] = _("ELEGANT CHARM");
